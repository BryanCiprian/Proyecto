...
public class UsuarioController {
	...
	@RequestMapping(value = "usuario/usuarioCrud.htm", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView inicioPageArticulo(ModelMap modelMap, HttpServletRequest request,
			HttpServletResponse response) {
		System.out.println("Iniciando vista crudUsuario");
		ModelAndView modelAndView = new ModelAndView("crudUsuario", modelMap);
		return modelAndView;
	}

	@RequestMapping(value = "usuario/executeCrudUsuario.htm", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
