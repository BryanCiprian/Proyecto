...
public class GrupoController {
	...
	@RequestMapping(value = "grupo/executeCrudGrupo.htm", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	//	CategoriaBean categoria = new CategoriaBean();
		Integer resultado = 0;
		try {
			if (opc.equals("listByClase")) {
				Integer id = Integer.parseInt(request.getParameter("id"));
				rpta.put("data", grupoService.listGrupoByIdClase(id));
