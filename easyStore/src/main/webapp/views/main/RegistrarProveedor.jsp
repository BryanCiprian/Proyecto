...
<div class="widget-body no-padding">
						...
						<form id="checkout-form" class="smart-form" novalidate="novalidate">
							...
							<fieldset>
							    <input type="hidden" name="idProv" class="idProv" />
							     <div class="row">
								...
								<div class="row">
									<section class="col col-6">
										<label class="input"> <i class="icon-prepend fa fa-user"></i>
									    <input class="form-control txtNumRuc" id="txtNumRuc" 
							         	name="txtNumRuc"  type="text"
								        placeholder="Ingrese Número de razón social " required
								        data-fv-notempty-message=" es necesario"> 
										</label>
									</section>
								    <section class="col col-6">
										<label class="input"> <i class="icon-prepend fa fa-user"></i>
											<input class="form-control txtNomRazSo" id="txtNomRazSo"
								name="txtNomRazSo"  type="text"
								...
								<div class="row">
									<section class="col col-6">
										<label class="input"> <i class="icon-prepend fa fa-user"></i>
									   <input class="form-control txtNomCom" id="txtNomCom" onkeypress="return soloLetras(event)"
								name="txtNomCom"  type="text"
								...
								data-fv-notempty-message=" es necesario">
								    ...
								    <section class="col col-6">
										<label class="input"> <i class="icon-prepend fa fa-user"></i>
										<input class="form-control txtUrlWeb" id="txtUrlWeb"
								name="txtUrlWeb"  type="text"
								placeholder="Ingrese página web " required
								data-fv-notempty-message=" es necesario">
										</label>
									</section>
