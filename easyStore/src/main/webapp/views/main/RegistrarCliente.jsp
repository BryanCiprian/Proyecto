...
<div class="widget-body no-padding">
						...
						<form id="checkout-form" class="smart-form" novalidate="novalidate">
							...
							<fieldset>
							    ...
							    <section class="col col-6">
								<label class="select">
                                <select class="form-control2 cboTipoCliente" id="cboTipoCliente" name="cboTipoCliente" >
								<option value="" selected="selected">Seleccione Tipo de cliente</option>
								<c:forEach items="${cmboTipoCliente}" var="cmbo">
							    <option value="${cmbo.idTipoCliente}">${cmbo.desTipoCliente}</option>
								</c:forEach>
								</select>
						     	<i></i>
						     	</label>
								...
								<section class="col col-6">
										<label class="input"> <i class="icon-prepend fa fa-user"></i>
									    <input class="form-control txtNomCom" id="txtNomCom"
							         	name="txtNomCom"  type="text"
								        placeholder="Ingrese nombre de la compañia" required 
								        data-fv-notempty-message=" es necesario"> 
										</label>
								</section>
							    </div>
